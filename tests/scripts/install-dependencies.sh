...
assert_json "test script untouched" "_.scripts.test === 'npm run test:unit && npm run test:e2e'" "./package.json"
assert_json "test:unit script untouched" "_.scripts['test:unit'] === 'jest'" "./package.json"
assert_json "test:e2e script untouched" "_.scripts['test:e2e'] === 'playwright test'" "./package.json"
